...
public abstract class PackageEvent extends ChangeClassifyingEvent {
	...
	/**
	 * Since JaMoPP can not deal with plain package folders we need to have the
	 * event on a file. Hence, if the event occurs on a IFolder we automatically
	 * change it to the package-info file.
	 *
	 * @param packageName
	 * @param iResource
	 */
