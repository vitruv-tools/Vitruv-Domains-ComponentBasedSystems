...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Java Feature EChange</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link tools.vitruv.domains.java.echange.feature.impl.JavaFeatureEChangeImpl#getOldAffectedEObject <em>Old Affected EObject</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class JavaFeatureEChangeImpl<A extends EObject, F extends EStructuralFeature> extends FeatureEChangeImpl<A, F> implements JavaFeatureEChange<A, F> {
	 ...
	 * @generated
	 */
	protected JavaFeatureEChangeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return FeaturePackage.Literals.JAVA_FEATURE_ECHANGE;
	}
		...
		if (oldAffectedEObject != null && oldAffectedEObject.eIsProxy()) {
			...
			if (oldAffectedEObject != oldOldAffectedEObject) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FeaturePackage.JAVA_FEATURE_ECHANGE__OLD_AFFECTED_EOBJECT, oldOldAffectedEObject, oldAffectedEObject));
			}
		}
	...
	public void setOldAffectedEObject(A newOldAffectedEObject) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FeaturePackage.JAVA_FEATURE_ECHANGE__OLD_AFFECTED_EOBJECT, oldOldAffectedEObject, oldAffectedEObject));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FeaturePackage.JAVA_FEATURE_ECHANGE__OLD_AFFECTED_EOBJECT:
