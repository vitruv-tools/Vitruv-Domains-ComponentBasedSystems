 ...
 * </p>
 * <ul>
 *   <li>{@link tools.vitruv.domains.java.echange.feature.JavaFeatureEChange#getOldAffectedEObject <em>Old Affected EObject</em>}</li>
 * </ul>
 *
...
public interface JavaFeatureEChange<A extends EObject, F extends EStructuralFeature> extends FeatureEChange<A, F> {
	 ...
	 * @see tools.vitruv.domains.java.echange.feature.FeaturePackage#getJavaFeatureEChange_OldAffectedEObject()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link tools.vitruv.domains.java.echange.feature.JavaFeatureEChange#getOldAffectedEObject <em>Old Affected EObject</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
